...
combineEst = function(x){
  cof = data.frame(summary(x)$coefficients)
  se = data.frame(summary(x)$standard.errors)
  cof_se = list("cof" = cof, "se" = se)
  return(cof_se)
}
...
randomTestAll = data.frame(randomTest1, randomTest2, randomTest3, randomTest4, randomTest5)
